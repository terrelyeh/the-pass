...
export const sources: Source[] = [
  ...
  // ============================================================
  { id: "the-spoon", name: "The Spoon", url: "https://thespoon.tech", feedUrl: "https://thespoon.tech/feed/", language: "en", category: "ai-food-tech", tier: 1, stream: "A", feedType: "rss", status: "active", description: "核心信源｜飲食×科技創新脊椎（AI、機器人、自動化、培養肉），新鮮題密度高、每天必看" },
  ...
  { id: "eater", name: "Eater", url: "https://www.eater.com", feedUrl: "https://www.eater.com/rss/index.xml", language: "en", category: "culture-opinion", tier: 1, stream: "A", feedType: "rss", status: "active", description: "核心信源｜飲食文化／餐廳／用餐趨勢旗艦，人味與在地題的主力、每天必看" },
  ...
  { id: "food-stadium", name: "フードスタジアム", url: "https://food-stadium.com", feedUrl: "https://food-stadium.com/feed/", language: "ja", category: "food-industry", tier: 3, stream: "A", feedType: "rss", status: "active", description: "日本外食產業媒體（feed 可用，待 density）" },
  { id: "foodrink-fdn", name: "フードリンクニュース FDN", url: "https://www.foodrink.co.jp", feedUrl: "https://www.foodrink.co.jp/rss.xml", language: "ja", category: "food-industry", tier: 3, stream: "A", feedType: "rss", status: "active", description: "日本外食情報（feed 可用 100篇，待 density）" },
  { id: "kfoodtimes", name: "한국외식신문", url: "https://www.kfoodtimes.com", feedUrl: "https://www.kfoodtimes.com/rss/allArticle.xml", language: "ko", category: "food-industry", tier: 3, stream: "A", feedType: "rss", status: "active", description: "韓國外食產業報（feed 可用，待 density）" },
  { id: "inshokuten", name: "飲食店ドットコム foodist", url: "https://www.inshokuten.com", feedUrl: "https://www.inshokuten.com/foodist/feed/", language: "ja", category: "food-industry", tier: 3, stream: "A", feedType: "rss", status: "active", description: "日本餐飲經營者媒體（feed 可用）" },
  { id: "gaishoku", name: "外食産業新聞社", url: "https://gaishoku.co.jp", feedUrl: "https://gaishoku.co.jp/feed/", language: "ja", category: "food-industry", tier: 4, stream: "A", feedType: "rss", status: "active", description: "日本外食產業報（feed 可用）" },
  { id: "nissyoku", name: "日本食糧新聞", url: "https://news.nissyoku.co.jp", feedUrl: "https://news.nissyoku.co.jp/feed/", language: "ja", category: "food-industry", tier: 3, stream: "A", feedType: "rss", status: "pending", description: "日本食品產業報（⚠️ feed 失效：只回 1 篇 2020 舊聞，待修）" },
